return {
  "folke/trouble.nvim",
  dependencies = { "nvim-tree/nvim-web-devicons", "folke/todo-comments.nvim" },  cmd="Trouble",
  opts={},
  keys = {
    { "<leader>xx", "<cmd>Trouble diagnostics toggle focus=true<cr>", desc = "Open/close trouble list" },
    { "<leader>xd", "<cmd>Trouble diagnostics toggle filter.buf=0 focus=true<CR>", desc = "Open trouble document diagnostics" },
